...
/**
 * Bean definitions for {@link DishRepository}.
 */
@Generated
public class DishRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'dishRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getDishRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'dishRepository'.
   */
  public static BeanDefinition getDishRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, DishRepository.class, Dish.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.cefii.learning.order_management.repository.DishRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.DishRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.cefii.learning.order_management.repository.DishRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getDishRepositoryInstanceSupplier();
