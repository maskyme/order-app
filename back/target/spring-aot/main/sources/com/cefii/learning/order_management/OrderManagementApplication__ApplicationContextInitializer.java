 ...
 */
@Generated
public class OrderManagementApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new OrderManagementApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new OrderManagementApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
